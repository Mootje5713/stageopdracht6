    ...
    <nav class="navigation navigation--docent">
        ...
        <div class="navigation-items">
            <ul class="navigation-items--main">
                ...
                <li><a href="manual.php" title="Stagiairs"><i class="flaticon group-1"></i>Stagiairs</a></li>
            </ul>
        </div>
                        ...
                        <div class="week-plan">
                            <div class="task has-popout">
                                    <p>
                                        <span>
                                            <p>
                                                Welkom beste praktijkbegeleider op het portaal van talent.
                                                Op dit portaal kun je je stagiairs zien en als je op de stagiairs link klikt  kun je zien hoeveel uren een stagiair heeft gemaakt,
                                                wat de stagiair heeft gedaan op ze stagedag en ook kan je het stageverslag het aantal uur wijzigen.
                                            </p>
                                        </span>
                                    </p>
                            </div>
