...
<section class="authenticator--wrapper" style="background-color: rgba(0, 0, 0, 0.25);" onclick="window.location.href='index.php?id=<?php echo $user_id ?>';">
            ...
            <div class="popover defaultPopoverWidth is-open" id="id1d" onclick="event.stopPropagation();">
                <form method="POST" action="" style="margin: 0;">
                    ...
                    <div class="s5-btn-row">
                        ...
                        <input type="submit" style="background: #0bca6a; border: 0;" class="btn btn-pri" name="submit" value="corrigeren">
                    </div>
                </form>
            </div>
        </div>
